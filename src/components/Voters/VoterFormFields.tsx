import { User, Mail, Phone, MapPin, Home, Calendar, Users, Building2, Building } from 'lucide-react';
import { Link } from 'react-router-dom';
import { UseFormReturn } from 'react-hook-form';
import { VoterFormData } from '../../schemas/voter.schema';
import MaskedInput from '../Common/MaskedInput';
import { masks } from '../../utils/masks';

interface VoterFormFieldsProps {
  form: UseFormReturn<VoterFormData>;
...
export default function VoterFormFields({
  form,
  onSubmit,
  handleCepChange,
  loadingCep,
