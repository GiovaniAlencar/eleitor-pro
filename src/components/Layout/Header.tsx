...
export default function Header({ onMenuClick }: HeaderProps) {
  return (
    <header className="bg-gradient-to-r from-navy-900 to-blue-900 text-white h-16 fixed w-full top-0 left-0 z-50">
      <div className="flex items-center justify-between h-full px-4">
        <div className="flex-1 flex items-center lg:flex-initial">
          <button
            onClick={onMenuClick}
            className="lg:hidden mr-4 hover:bg-white/10 p-2 rounded-lg transition-colors"
          >
